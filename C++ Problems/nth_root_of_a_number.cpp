...
//function that will multiply by n times
double multiply(double mid,int n){
	...
	return ans;
} // ye function mid ko n times multiply kardega
...
// time complexity:::: log(search space) = n*log(n*(10^d)); d= digit precison/accuracy.